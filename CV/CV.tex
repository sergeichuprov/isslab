...
\itemsep-0.5em
    ...
    \item Assistant Professor (tenure-track) at The University of Texas Rio Grande Valley (UTRGV) since September 2024, building on previous research and mentoring experience at multiple institutions.
    \item 64 peer-reviewed publications, 2 pending patent applications, Google Scholar \textit{\textbf{h}}-index: 10.
    \item My publication list includes renowned peer-reviewed conferences and journals, such as ICML, IEEE TDSC, IEEE Intelligent Systems, IEEE Systems Journal, IEEE WCCI, DSN, and others.
    %\item My research has been supported by NSF, DoD (USMA), CRDF Global, and other funding agencies.
    \item I have valuable experience participating in R\&D projects supported by NSF, U.S.\ Department of Transportation, DoD (USMA), CRDF Global, and other funding agencies.
...
\begin{itemize}
\itemsep-0.5em
    \item \textit{Spring 2026:} CSCI 2380 Computer Science II (undergraduate); CSCI 8370 Intelligent Security Systems (PhD)
    \item \textit{Fall 2025:} CSCI 2380 Computer Science II (undergraduate); CSCI 4341 Foundations of Intelligent Security Systems (undergraduate)
    \item \textit{Spring 2025:} CSCI 2380 Computer Science II (undergraduate); CSCI 6370 Foundations of Intelligent Security Systems (graduate)
\end{itemize}
...
{\bf AI-Based Real-Time Video Surveillance of Stuck Vehicles and Debris on Railway Grade Crossings} (Co-PI; PI: Dr.\ Gasser Ali) \\
\hspace*{\fill} {\em September 2026 - December 2027}
\vspace{-0.3cm}
\begin{itemize}
\itemsep-0.5em
\item \textbf{Objective:} to develop AI/ML-based computer vision methods and software tools for real-time detection of stuck vehicles and debris on railway grade crossings, improving railway safety and reducing incident response times. The project is supported by the U.S.\ Department of Transportation (award number to be assigned), \$124,976.
\end{itemize}

{\bf Collaborative research: IDEAS lab: ETAUS: Smarter Microbial Observatories for Realtime ExperimentS (SMORES)} (Volunteer Collaborator) \\
\hspace*{\fill} {\em August 2023 - present}
\vspace{-0.3cm}
\begin{itemize}
\itemsep-0.5em
\item \textbf{Objective:} this project involves the collaboration between RIT, Harvard University, Florida International University, and the University of Georgia to study marine sediments and their role in natural carbon sequestration, using AI and ML to optimize data collection and predictions during field experiments. The project is supported by NSF award \#2321652.
\end{itemize}

{\bf Enhancing Security and Privacy of the Conventional Federated Learning} (non PI or Co-PI) \\
\hspace*{\fill} {\em September 2022 - July 2024}
\vspace{-0.3cm}
\begin{itemize}
\itemsep-0.5em
...
The project was supported by the United States Military Academy (USMA) and was accomplished under Grant Number W911NF-20-1-0337.
\end{itemize}
...
\textbf{U.S.\ Department of Transportation Award} (Co-PI; PI: Dr.\ Gasser Ali) \hfill {\em September 2026 - December 2027} \\
\textit{AI-Based Real-Time Video Surveillance of Stuck Vehicles and Debris on Railway Grade Crossings}, \textbf{\$124,976}

\vspace{-1mm}
\textbf{UTRGV Research Start-Up Funds} (sole PI) \hfill {\em September 2024 - August 2026} \\
Two-year start-up package awarded upon joining UTRGV as a tenure-track Assistant Professor, \textbf{\$151,260}. Edinburg, TX, USA.

\item FACULTY AWARDS:

\textbf{\href{https://teachaccess.org/teach-access-fellowship-program/}{2025 Teach Access Fellowship}}, \textbf{\$4,000} (scholarship) \hfill {\em December 2024} \\ USA

\item STUDENT GRANTS AND SCHOLARSHIPS:

\textbf{Amazon AWS Cloud Credit for Research} (sole PI) \hfill {\em August 2022} \\
Awarded an AWS research promotional credit for one year, \textbf{\$4,000}. Rochester, NY, USA.
...
\vspace{-1mm}
\textbf{Scholarship of the Russian Federation President for Students of Higher Education} \hfill {\em May 2021} \\ \textbf{Universities Studying Abroad in 2021/2022 Academic Year}, \textbf{\$16,400} \\
Saint-Petersburg, Russia
...
\begin{rSection}{Invited Talks \& Sessions}
    \textbf{Faculty Lightning Talk at UTRGV AI Research Day, Edinburg, TX, USA}\hfill\small{\em 20-21 May 2026}\normalsize\\
    \textbf{Title:} \textit{How I Use AI in My Research}\\

    \textbf{Invited Talk (remote) at \href{https://sites.google.com/view/t2p-workshop/home}{From Theory to Practice (T2P)} Workshop, Kigali, Rwanda}\hfill\small{\em 16 April 2024}\normalsize\\
...
\item \href{https://www.mdpi.com/journal/electronics/special_issues/H3RAMJ66OF}{MDPI Electronics Special Issue: ``Cybersecurity Solutions for Intelligent Systems''} (2026)
\end{itemize}

\textbf{Journal Reviewer:}
\begin{itemize}\itemsep-0.5em
\item IEEE Transactions on Artificial Intelligence (2025, 2026)
\item IEEE Transactions on Instrumentation and Measurement (2026)
\item IEEE Transactions on Dependable and Secure Computing (2026)
\item IEEE Internet of Things Journal (2024-2026)
\item ACM Journal of Data and Information Quality (2024-2026)
\item MDPI Electronics (2024-2026)
\item MDPI Future Internet (2026)
\item MDPI Data (2026)
\item MDPI Sensors (2024-2025)
\item MDPI Network (2024-2025)
\end{itemize}

\textbf{Conference Reviewer:}
\begin{itemize}\itemsep-0.5em
\item International Joint Conference on Neural Networks (IJCNN) --- 2024 (as part of IEEE WCCI), 2025, 2026
\item 39th International FLAIRS Conference (2026)
\item International Conference on Neural Information Processing (ICONIP) --- 2023
\end{itemize}

\item FACULTY ADVISING (STUDENT ORGANIZATIONS):

\textbf{\href{https://vaqueroisi.org/}{Vaquero Information Security Initiative (VaqueroISI)}} --- Lead Faculty Advisor \hfill\small{\em 2026 - present}\normalsize \\
\textbf{The University of Texas Rio Grande Valley, Edinburg, TX, USA} \\
Cybersecurity student club launched in 2026; 120+ members in the club's Discord channel.

\item VOLUNTEERING:

\textbf{UTRGV STEM Conference, Edinburg, TX, USA}\hfill\small{\em 24-25 April 2026}\normalsize
\\{\em Volunteer Judge and Oral Presentation Section Moderator}
\\ Judged student presentations and moderated an oral presentation section.
...
\item STUDENT ADVISING AND MENTORING:

\textbf{The University of Texas Rio Grande Valley, Edinburg, TX, USA} \hfill\small{\em 2024-2026}\normalsize
\begin{itemize}\itemsep-0.5em
\item \textbf{PhD:} Angel Peredo (2024-2026); Pedro Fonseca (2024-2026)
\item \textbf{MS:} Ei Ei Nyein Chan (2025-2026); Adrian Peña (2025-2026); Ruben James Aleman (2026); Bryn Ramirez (2025)
\item \textbf{BS:} Andrew Alvarez (2024-2026); Gael Marquez (2025-2026); Damian Villarreal (2025-2026, will start MS in Computer Science at UTRGV in Fall 2026); Ruby Gonzalez (2025-2026, will start MS in Computer Science at UTRGV in Fall 2026); David Sanchez (2025-2026, will start MS in Computer Science at UTRGV in Fall 2026); Liam Reeves (2026, supported by UTRGV Engaged Scholar Award for Undergraduate Research under SMART 2.0 program, with Dr.\ Chuprov as mentor); Danny McClain (2025); Eduardo Dominguez (2024-2025, supported by UTRGV Engaged Scholar Award for Undergraduate Research)
\end{itemize}

\textbf{Rochester Institute of Technology, NY, USA} \hfill\small{\em 2023-2024}\normalsize
\begin{itemize}\itemsep-0.5em
\item Harshil Pravinbhai Patel (MS, 2024) --- capstone: ``Improving Federated Learning Security with Trust Evaluation to Detect Adversarial Attacks''
\item Shweta Sandip Sharma (MS, 2024) --- capstone: ``Analyzing Effects of Adversarial Attacks on Classifier Performance''
\item Gaurav Thakur (MS, 2024) --- capstone: ``Resilience of Federated Learning Models in Image Classification Under Data Degradation''
\item Vedika Vishwanath Painjane (MS, 2024) --- capstone: ``Analyzing the Effect of Data Poisoning on Semantic Segmentation Using Federated Learning''
\item Anirudh Narayanan (MS, 2024) --- capstone: ``Soccer Games Automatic Video Highlights Generator'' [\href{https://github.com/Anirudhrn98/Event_Detection_Soccer}{GitHub}]
\item Moinuddin Memon (MS, 2023) --- capstone: ``Knowledge-Based Client Filtering Algorithm for Federated Learning'' (see [C10])
\end{itemize}

\textbf{ITMO University, Saint Petersburg, Russia} \hfill\small{\em 2020-2021}\normalsize
\begin{itemize}\itemsep-0.5em
\item Ilya Sakhno (BS, 2021) --- qualification project: ``Unified Security Profile for Contactless Payment Technology''
\item Egor Marinenkov (BS, 2020) --- qualification project: ``Detecting Data Integrity Violations in Cyber-Physical Systems using Game Theory Approach'' (see [J5] and [C31])
\end{itemize}
