...
\itemsep-0.5em
    ...
    \item 59 peer-reviewed publications, 2 pending patent applications, Google Scholar \textit{\textbf{h}}-index: 9.
...
\item IEEE Transactions on Artificial Intelligence (2025)
\item IEEE Internet of Things Journal (2024-2025)
\item ACM Journal of Data and Information Quality (2024-2025)
\item MDPI Sensors (2024-2025)
\item MDPI Network (2024-2025)
\item MDPI Electronics (2024-2025)
\end{itemize}

\textbf{Conference Reviewer:}
\begin{itemize}\itemsep-0.5em
\item International Joint Conference on Neural Networks (IJCNN) --- 2024 (as part of IEEE WCCI), 2025
...
\begin{itemize}\itemsep-0.5em
\item \textbf{PhD:} Angel Peredo (2025); Pedro Fonseca (2024-2025)
\item \textbf{MS:} Bryn Ramirez (2025); Ei Ei Nyein Chan (2025); Adrian Peña (2024-2025)
\item \textbf{BS:} Andrew Alwarez, Nathaniel Deleon, Kayla Luevanos, Gael Marquez, Danny McClain, Damian Villarreal (all 2025); Eduardo Dominguez (2024-2025, supported by UTRGV Engaged Scholar Award for Undergraduate Research, with Dr.\ Chuprov as mentor); Carlos Sepulveda (2024)
\end{itemize}
